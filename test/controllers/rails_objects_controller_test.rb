...
class RailsObjectsControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create rails_object" do
    assert_difference('RailsObject.count') do
      post :create, rails_object: { firstName: @rails_object.firstName, gender: @rails_object.gender, lastName: @rails_object.lastName }
    end
  ...
  test "should update rails_object" do
    patch :update, id: @rails_object, rails_object: { firstName: @rails_object.firstName, gender: @rails_object.gender, lastName: @rails_object.lastName }
    assert_redirected_to rails_object_path(assigns(:rails_object))
  end
